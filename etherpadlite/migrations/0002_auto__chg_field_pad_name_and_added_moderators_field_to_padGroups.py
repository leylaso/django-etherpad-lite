...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field moderators on 'PadGroup'
        db.create_table('etherpadlite_padgroup_moderators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('padgroup', models.ForeignKey(orm['etherpadlite.padgroup'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('etherpadlite_padgroup_moderators', ['padgroup_id', 'user_id'])


        # Changing field 'Pad.name'
        db.alter_column('etherpadlite_pad', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Removing M2M table for field moderators on 'PadGroup'
        db.delete_table('etherpadlite_padgroup_moderators')


        # Changing field 'Pad.name'
        db.alter_column('etherpadlite_pad', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))
