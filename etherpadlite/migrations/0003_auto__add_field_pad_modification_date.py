...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pad.modification_date'
        db.add_column('etherpadlite_pad', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pad.modification_date'
        db.delete_column('etherpadlite_pad', 'modification_date')
    ...
    models = {
        ...
        'etherpadlite.pad': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 19, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
